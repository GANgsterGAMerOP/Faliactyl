...
console.log(chalk.green("[FoxyNodes] Files loaded..."));

// Load settings.

const settings = require("./settings.json");
console.log(chalk.green("[FoxyNodes] Settings loaded..."));
...
console.log(chalk.green("[FoxyNodes] Pages loaded..."));
...
const listener = app.listen(settings.website.port, function() {
  console.log(chalk.green("[FoxyNodes] Checking for updates..."));
  // no update system yet, soontm
  console.log(chalk.green("[FoxyNodes] Finishing & deploying FoxyNodes..."));
